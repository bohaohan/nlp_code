    ...
    def __init__(self, sequence_length, num_classes, height,
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope("conv-maxpool-%s" % filter_size):
                ...
                bn = BN(num_filter, 0.001, ewma, True)
                ...
                # filter_shape = [filter_size, 1, num_filter, num_filters]
                # W = tf.Variable(tf.truncated_normal(filter_shape, stddev=0.1), name="W")
                ...
                # filter_shape_cm2 = [sequence_length - 2*filter_size + 2, 2, num_filters, num_filters]
